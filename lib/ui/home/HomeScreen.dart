...
import 'package:emartconsumer/ui/home/CurrentAddressChangeScreen.dart';
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child:
                                    Text(currentLocation.toString(), maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 14, color: Color(COLOR_PRIMARY), fontFamily: "Poppinsr"))
                                        .tr(),
                              ),
                              InkWell(
                                onTap: () {
                                ...
                                child: Container(
                                  ...
                                  child: Text("Change".tr(), style: TextStyle(fontSize: 14, color: Color(COLOR_PRIMARY), fontFamily: "Poppinsr")).tr(),
                                ),
                              ),
                            ],
                          )),
                      Container(
                          padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 16),
                          child: Text("Hello".tr() + " " + name! + ",", style: TextStyle(fontSize: 24, color: Color(COLOR_PRIMARY), fontFamily: "Poppinsr")).tr()),
                      Container(
                          padding: const EdgeInsets.only(top: 0, left: 16, bottom: 20, right: 16),
                          child: Row(
                            children: [
                              Expanded(
                                child: Text("Find your Store".tr(), style: TextStyle(fontSize: 26, color: isDarkMode(context) ? Colors.white : const Color(0xFF333333), fontFamily: "Poppinssb")).tr(),
                              ),
                              DropdownButton(
