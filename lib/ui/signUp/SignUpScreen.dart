...
class _SignUpState extends State<SignUpScreen> {
        ...
        InkWell(
          ...
          child: Padding(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), border: Border.all(color: Color(COLOR_PRIMARY), width: 1)),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Color(COLOR_PRIMARY), fontWeight: FontWeight.bold, fontSize: 12, letterSpacing: 1),
                  ),
                ])),
          ),
        )
  ...
  _signUpWithEmailAndPassword() async {
    ...
    dynamic result = await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!);
    await hideProgress();
