  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: isLocationAvail
            ? showEmptyState("We don't have your location.".tr(), context, action: () async {
                if (islocationGet) {
                } else {
                              ...
                              if ((snapshot.hasData || (snapshot.data?.isNotEmpty ?? false)) && mounted) {
                                return Container(
                                    ...
                                    child: GridView.count(
                                      ...
                                      children: List.generate(snapshot.data!.length >= 8 ? 8 : snapshot.data!.length, (index) => buildCategoryItem(snapshot.data![index])),
                                    ));
                              } else {
                        ...
                        child: Column(
                          children: [
                            Padding(
                              ...
                              child: buildTitleRow(
                                titleValue: "Popular".tr() + " $SELECTED_SECTION_NAME " + "Store".tr(),
                                onClick: () {
                                  push(
                                    context,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(child: Text(model.title.toString(), style: TextStyle(color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontFamily: "Poppinsr", fontSize: 12)).tr()),
          )
        ],
      ),
    );
                            ...
                            child: Padding(
                              ...
                              child: Center(
                                child: Padding(
                                  ...
                                  child: Text(
                                    discountAmountTempList.isNotEmpty ? discountAmountTempList.reduce(min).toStringAsFixed(decimal) + "% off" : "0",
                                    style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
                                  ),
                                ),
                              ),
